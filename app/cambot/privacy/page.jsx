...
const page = () => {
  return (
    <div className="flex flex-col align-center text-left">
      <p className="font-bold text-center text-3xl">Privacy Policy </p>
      <p>
        Jordan Lee built the CamBot app as an Open Source app. This SERVICE is
        provided by Jordan Lee at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at CamBot unless otherwise
        defined in this Privacy Policy.
      </p>{" "}
      <p className="font-bold text-center">Information Collection and Use</p>{" "}
      <p>
        For a better experience, while using our Service, I may require you to
        provide us with certain personally identifiable information, including
        but not limited to Discord User ID, Discord Server ID. The information
        that I request will be retained on your device and is not collected by
        me in any way.
      </p>{" "}
      <p className="font-bold text-center">Log Data</p>{" "}
      <p>
      ...
      <p className="font-bold text-center">Cookies</p>{" "}
      <p>
      ...
      <p className="font-bold text-center">Service Providers</p>{" "}
      <p>
      ...
      <p className="font-bold text-center">Security</p>{" "}
      <p>
      ...
      <p className="font-bold text-center">Links to Other Sites</p>{" "}
      <p>
      ...
      <p className="font-bold text-center">Children’s Privacy</p>{" "}
      <div>
        <p>
      ...
      <p className="font-bold text-center">Changes to This Privacy Policy</p>{" "}
      <p>
        I may update our Privacy Policy from time to time. Thus, you are advised
        to review this page periodically for any changes. I will notify you of
        any changes by posting the new Privacy Policy on this page.
      </p>{" "}
      <p className="font-bold">This policy is effective as of 2023-12-29</p> <p className="font-bold text-center">Contact Us</p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at jtlee@rmgj2.com.
      </p>{" "}
      <p>
